...
public class ScannedImage {
    ...
    public ScannedImage(long scannedImageId, long uploadedUserId, string scannedImageMedia, long predictedSerpentType, float accuracy)
    {
    ...
    public static ScannedImageDto ToScannedImageDto(ScannedImage scannedImage, string userfname, string userlname, string serpentName)
    {
